...
from models.Alignment_SG3 import Alignment_SG3
from models.Embedding_sg3 import Embedding_sg3
...
def main(args):
    ...
    # Step 1 : Embedding source and target images into W+ from stylegan3, FS space froM Babershop size 32x32x512
    ...
    if im_paths_not_embedded:
        ...
        re4e.invert_images_in_W3(args,im_paths_not_embedded)
        re4e.invert_images_in_FS(im_paths_not_embedded)
...
if __name__ == "__main__":
    ...
    # StyleGAN3 setting
    parser.add_argument('--stylegan3_weights', type=str, default=Path(model_paths["stylegan3_ffhq_pt"]))
